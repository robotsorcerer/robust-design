...
figure(1)
plot(1:I+1,Knorm,'LineWidth',1.3)
...
grid on
xlim([1,I+1])
set(gca,'XTick',[1:100:I+1]);
grid on
set(gca, 'LooseInset', [0,0,0,0]);
% set (gcf,'Position',[0,0,500,500]);
saveas(gca, 'Plots/Knorm_robust_triple_Natural.eps', 'epsc')
...
set(gca,'FontSize',30)
xlim([1,I])
set(gca,'XTick',[1:100:I]);
grid on
set(gca, 'LooseInset', [0,0,0,0]);
% set (gcf,'Position',[0,0,500,500]);
saveas(gca, 'Plots/Pnorm_robust_triple_Natural.eps', 'epsc')
...
figure(3)
plot(1:I+1,Hnorm,'LineWidth',1.3)
xlabel({'\bf Iterations'},'Interpreter','latex','FontSize',30)
...
grid on
set(gca, 'LooseInset', [0,0,0,0]);
saveas(gca, 'Plots/Hnorm_robust_triple_Natural.eps', 'epsc')
% set (gcf,'Position',[0,0,500,500]);
